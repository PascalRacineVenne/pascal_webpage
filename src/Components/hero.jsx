...
const Hero = () => {
  return (
    <section className="hero__StyledHeroSection section1">
      ...
      <div>
        <p>I'm a front-end developer specializing in building great digital experiences.  Currently, I'm focused on gathering different knowledges into accessible and human-oriented projects.</p>
      </div>
      <div>
