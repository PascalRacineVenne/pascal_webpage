    ...
    <section id="about" className="about__StyledAbout section">
      ...
      <div className="inner_about_me">
        <div className="about__StyledText">
          <p>
            As a recent graduate of <a href="https://www.lewagon.com/" className="link_wagon" alt="Le Wagon" target="_blank" rel="noreferrer">Le Wagon</a> full stack coding bootcamp, my main
